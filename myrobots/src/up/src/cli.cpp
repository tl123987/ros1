...
*/
typedef actionlib::SimpleActionClient<up::addAction> Client;


//处理最终结果
void done_cb(const actionlib::SimpleClientGoalState &state, const up::addResultConstPtr &result){
...
//处理连续反馈
void  feedback_cb(const up::addFeedbackConstPtr &feedback){
