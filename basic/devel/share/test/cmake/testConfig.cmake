...
if("TRUE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /media/y/Elements/ubuntu/ros resoure/ros1/basic/src/test)
  set(test_DEVEL_PREFIX /media/y/Elements/ubuntu/ros resoure/ros1/basic/devel)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /media/y/Elements/ubuntu/ros resoure/ros1/basic/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/y/Elements/ubuntu/ros resoure/ros1/basic/src/test/${idir}'.  ${_report}")
    endif()
