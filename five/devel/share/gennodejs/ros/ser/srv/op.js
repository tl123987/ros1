...
class opRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type opRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type opRequest
    let len;
    let data = new opRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new opRequest(null);
...
class opResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type opResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type opResponse
    let len;
    let data = new opResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new opResponse(null);
